...
function (_Component) {
  ...
  function ListItem(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "DataSelect", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onHandleDialog", function () {
      var _this$props2 = _this.props,
          id = _this$props2.list_massage.id,
          DataALL = _this$props2.DataALL;
      var res = DataALL.filter(function (t) {
        return t.id == id;
      });
      console.log(res);
...
//# sourceMappingURL=index.js.5f30ae1130d2f2a566de.hot-update.js.map